...
ggplot(ego_UCMC_logFC, aes(x=logFC, y=Description, color = age)) + 
     geom_point() +
     annotate("segment",x = 8.1, xend = 8.1, y = "nuclear-transcribed mRNA catabolic process, nonsense-mediated decay", yend = "response to cadmium ion") + 
     annotate("segment",x = 8, xend = 8.1, y = "nuclear-transcribed mRNA catabolic process, nonsense-mediated decay", yend = "nuclear-transcribed mRNA catabolic process, nonsense-mediated decay") + 
     annotate("segment",x = 8, xend = 8.1, y = "response to cadmium ion", yend = "response to cadmium ion") +
     annotate("text", x = 8.5, y = "protein arginylation",label = "UC") + 
     annotate("segment",x = 8.1, xend = 8.1, y = "system process", yend = "maintenance of cell number") + 
     annotate("segment",x = 8, xend = 8.1, y = "system process", yend = "system process") + 
     annotate("segment",x = 8, xend = 8.1, y = "maintenance of cell number", yend = "maintenance of cell number") +
     annotate("text", x = 8.5, y = "regulation of multi-organism process",label = "MC")
